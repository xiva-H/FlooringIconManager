...
public class searchResultActivity extends AppCompatActivity implements RecycleAdapter.clickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().getExtras() != null) {
            ...
            searchDBO = new DBO(searchResultActivity.this);
            ...
            ra = new RecycleAdapter(searchResultActivity.this, product_name, product_brand,
                    product_qty, product_sqft, product_store, product_color, product_price,
                    product_type, product_size, this);
            rw.setAdapter(ra);
            rw.setLayoutManager(new LinearLayoutManager(searchResultActivity.this));
        }
    ...
    void getProducts(String searchPhrase1, String searchPhrase2, String searchPhrase3, String searchPhrase4, String searchPhrase5, String searchPhrase6, String searchPhrase7, int searchFlag){
        ...
        if(c.getCount() != 0){
            while(c.moveToNext()){
                ...
                product_sqft.add(String.format("%.2f",(Double.valueOf(c.getString(4)) * Double.valueOf(c.getString(9)))));
    ...
    public void onListClick(int pos) {
        ...
        Intent i = new Intent(this, productInfoPageActivity.class);
        i.putExtra("product_sqft", String.valueOf(product_sqft.get(pos)));
